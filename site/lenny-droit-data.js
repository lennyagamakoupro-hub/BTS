...
(function () {
  ...
  const STU = {
    mdsources: {
      cards: [
        { q: "Qu'est-ce que le Droit ?", a: "L'ensemble des règles qui organisent la vie en société, assorties d'une sanction édictée par l'institution judiciaire.", ex: "Brûler un feu rouge enfreint le Code de la route → amende : une règle de conduite assortie d'une sanction." },
        { q: "Droit objectif vs droits subjectifs ?", a: "Droit objectif = l'ensemble des règles applicables dans une société. Droits subjectifs = les prérogatives reconnues aux personnes (« j'ai le droit de… »).", ex: "Droit objectif : la loi impose au locataire de payer son loyer. Droit subjectif : le propriétaire a le droit d'en réclamer le paiement." },
        { q: "Qu'est-ce que le droit positif ?", a: "L'ensemble des règles juridiques effectives en vigueur dans un État à un moment donné — le droit tel qu'il existe réellement.", ex: "En France aujourd'hui, le Code civil en vigueur est du droit positif ; une loi abrogée ne l'est plus." },
        { q: "Les 4 caractères de la règle de droit ?", a: "Générale · impersonnelle (abstraite) · obligatoire · coercitive (sanction civile ou pénale).", ex: "« Tout conducteur s'arrête au feu rouge » : générale (tous), impersonnelle (personne nommée), obligatoire, sanctionnée par une amende." },
        { q: "Droit public vs droit privé ?", a: "Public : organisation et fonctionnement des pouvoirs publics (intérêt général). Privé : rapports entre particuliers (le droit civil est le droit commun).", ex: "Public : un permis de construire refusé par la mairie. Privé : un litige entre un vendeur et un acquéreur sur un compromis." },
        ...
        { q: "Règlement européen vs directive ?", a: "Le règlement s'applique directement et uniformément (primauté, effet direct). La directive fixe un but à atteindre et doit être transposée en droit national.", ex: "Le RGPD (règlement) s'applique tel quel partout. Une directive « performance énergétique » doit d'abord être traduite en loi française." },
        ...
        { q: "Le principe de non-rétroactivité ?", a: "Art. 2 du Code civil : « la loi ne dispose que pour l'avenir, elle n'a point d'effet rétroactif » (théorie des droits acquis).", ex: "Une loi votée en 2026 ne peut pas sanctionner un acte parfaitement légal commis en 2024." },
