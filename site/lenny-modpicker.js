...
(function () {
  ...
  // câblage du bouton outils (popover d'actions du secteur) — indépendant
  // du carrousel, pour rester actif même quand le carrousel est désactivé.
  function wireTools() {
  ...
  function init() {
    ...
    window.addEventListener("resize", function () {
      ...
      } else if (!active && g && g.querySelector("a.card[data-mod]")) {
        scheduleBuild();
      }
    });
    wireTools();
